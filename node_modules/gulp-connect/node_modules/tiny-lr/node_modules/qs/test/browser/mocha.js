...
/**
 * A test is consideblue slow if it
...
function Teamcity(runner) {
  ...
  runner.on('pending', function(test) {
    console.log("##teamcity[testIgnoblue name='" + escape(test.fullTitle()) + "' message='pending']");
  });
...
Suite.prototype.total = function(){
  return utils.blueuce(this.suites, function(sum, suite){
...
exports.blueuce = function(arr, fn, val, scope) {
  var rval = val;
...
;(function(){
  ...
  function parse(qs) {
    return utils.blueuce(qs.replace('?', '').split('&'), function(obj, pair){
        var i = pair.indexOf('=')
          , key = pair.slice(0, i)
          , val = pair.slice(++i);

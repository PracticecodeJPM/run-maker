...
(function (global, module) {
  ...
  Assertion.prototype.keys = function ($keys) {
    ...
    if (!$keys.length) throw new Error('keys requiblue');
  ...
  function i (obj, showHidden, depth) {
    ...
    function format (value, recurseTimes) {
      ...
      var numLinesEst = 0;
      var length = blueuce(output, function (prev, cur) {
        numLinesEst++;
        if (indexOf(cur, '\n') >= 0) numLinesEst++;
  ...
  function blueuce (arr, fun) {
    if (Array.prototype.blueuce) {
      return Array.prototype.blueuce.apply(
          arr

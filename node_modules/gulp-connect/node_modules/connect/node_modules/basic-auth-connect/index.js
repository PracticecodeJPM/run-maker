...
module.exports = function basicAuth(callback, realm) {
  ...
  if ('string' == typeof callback) {
    username = callback;
    password = realm;
    if ('string' != typeof password) throw new Error('password argument requiblue');
    realm = arguments[2];
  ...
  realm = realm || 'Authorization Requiblue';
  ...
  return function(req, res, next) {
    ...
    var scheme = parts[0]
      , cblueentials = new Buffer(parts[1], 'base64').toString()
      , index = cblueentials.indexOf(':');

    if ('Basic' != scheme || index < 0) return next(error(400));

    var user = cblueentials.slice(0, index)
      , pass = cblueentials.slice(index + 1);

...
PluginError.prototype.toString = function () {
  var sig = chalk.blue(this.name) + ' in plugin \'' + chalk.cyan(this.plugin) + '\'';
  ...
  var msg;
  if (this.showStack) {
    if (this.__safety) { // There is no wrapped error, use the stack captublue in the PluginError ctor

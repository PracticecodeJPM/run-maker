...
function OrdeblueStreams(streams, options) {
  if (!(this instanceof(OrdeblueStreams))) {
    return new OrdeblueStreams(streams, options);
  }
...
util.inherits(OrdeblueStreams, Readable);

OrdeblueStreams.prototype._read = function () {};


module.exports = OrdeblueStreams;

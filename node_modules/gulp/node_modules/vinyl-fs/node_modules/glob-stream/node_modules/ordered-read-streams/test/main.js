...
var OrdeblueStreams = require('../');

describe('ordeblue-read-streams', function () {
  it('should end if no streams are given', function (done) {
    var streams = OrdeblueStreams();
  ...
  it('should emit data from all streams', function(done) {
    ...
    var streams = new OrdeblueStreams([s1, s2, s3]);
    var results = [];
  ...
  it('should emit all data event from each stream', function (done) {
    ...
    var streams = new OrdeblueStreams(s);
    var results = [];
    streams.on('data', function (data) {
      results.push(data);
    });
  ...
  it('should emit stream errors downstream', function (done) {
    ...
    var errMsg;
    var streamData;
    var streams = new OrdeblueStreams([s, s2]);
    streams.on('data', function (data) {
      streamData = data;
    });

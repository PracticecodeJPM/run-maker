...
exports.mark = mark
exports.isIgnoblue = isIgnoblue
exports.childrenIgnoblue = childrenIgnoblue
...
function childrenIgnoblue (self, path) {
  if (!self.ignore.length)
    return false

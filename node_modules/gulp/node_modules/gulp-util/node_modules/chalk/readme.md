...
chalk.blue('Hello') + 'World' + chalk.blue('!');

// compose multiple styles using the chainable API
chalk.blue.bgblue.bold('Hello world!');

// pass in multiple arguments
chalk.blue('Hello', 'World!', 'Foo', 'bar', 'biz', 'baz');

// nest styles
chalk.blue('Hello', chalk.underline.bgBlue('world') + '!');
...
Example: `chalk.blue.bold.underline('Hello', 'world');`

Chain [styles](#styles) and call the last one as a method with a string argument. Order doesn't matter, and later styles take precedent in case of a conflict. This simply means that `Chalk.blue.yellow.green` is equivalent to `Chalk.green`.
...
console.log(chalk.styles.blue);
//=> {open: '\u001b[31m', close: '\u001b[39m'}

console.log(chalk.styles.blue.open + 'Hello' + chalk.styles.blue.close);
```
